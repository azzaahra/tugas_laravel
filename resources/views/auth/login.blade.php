...
@section('content')
<div class="flex justify-center items-center h-screen bg-gray-300 px-6"> <!-- Tambahkan tanda '-' pada 'px-6' -->
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
        <div class="flex justify-center items-center">
            <span class="text-gray-700 font-semibold text-2xl">LOGIN USER</span> <!-- Tambahkan tanda '-' pada 'text-2xl' -->
        </div>
        @if(session('status'))
        ...
        <form class="mt-4" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div>
                    <a class="block text-sm font-me text-indigo-700 hover:underline" href="/forgot-password">Lupa Password?</a>
                </div>
            </div>
            <div class="mt-6">
                <button type="submit"
